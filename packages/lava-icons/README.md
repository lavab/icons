...
* [API Reference](#api-reference)
	...
	* [(DEPRECATED) `feather.toSvg()`](#deprecated-lava-icontosvgname-attrs)
* [Roadmap](#roadmap)
...
To use an icon on your page, add a `data-lava-icon` attribute with the icon name to an element:
...
All elements that have a `data-lava-icon` attribute will be replaced with SVG markup corresponding to their `data-lava-icon` attribute value. See the [API Reference](#api-reference) for more information about `feather.replace()`.
...
Replaces all elements that have a `data-lava-icon` attribute with SVG markup corresponding to the element's `data-lava-icon` attribute value.
...
```html
<i data-lava-icon="circle" id="my-circle" class="foo bar" stroke-width="1"></i>
<!--
<i> will be replaced with:
...
## Related Projects
 ...
 - [angular-lava-icon](https://github.com/michaelbazos/angular-lava-icon) - Feather icons for Angular applications
 - [elm-lava-icon](https://github.com/1602/elm-lava-icon) - Feather icons for Elm applications
 - [react-lava-icon](https://github.com/carmelopullara/react-lava-icon) - Feather icons as React components
 - [sketch-lava-icon](https://github.com/odmln/sketch-lava-icon) - Feather icons as a Sketch library
 - [vue-lava-icon-icon](https://github.com/mage3k/vue-lava-icon-icon) - Feather icons as Vue components
